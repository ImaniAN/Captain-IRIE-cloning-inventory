...
--HealthStatus all must = 1 for Healthy status 
--(2023-03-07)
-- Insert data into Daughter Table
...
VALUES
    -- Entries for Mother 1 (CutID = 1)
    (1, 100, 1, 1, 1, 1, '2023-03-07', '2023-03-07', 'Green', 1, 'Kept'),
    (1, 100, 1, 1, 1, 1, '2023-03-07', '2023-03-07', 'Green', 1, 'Sold'),
    (1, 100, 1, 1, 1, 1, '2023-03-07', '2023-03-07', 'Green', 1, 'Destroyed'),
    (1, 100, 1, 1, 1, 1, '2023-03-07', '2023-03-07', 'Green', 1, 'Donated'),

    -- Entries for Mother 2 (CutID = 2)
    (2, 100, 1, 2, 2, 2, '2023-03-07', '2023-03-07', 'Green', 1, 'Kept'),
    (2, 100, 1, 2, 2, 2, '2023-03-07', '2023-03-07', 'Green', 1, 'Sold'),
    (2, 100, 1, 2, 2, 2, '2023-03-07', '2023-03-07', 'Green', 1, 'Destroyed'),
    (2, 100, 1, 2, 2, 2, '2023-03-07', '2023-03-07', 'Green', 1, 'Donated'),

    -- Continue with the same pattern for the remaining mothers and cuttings (up to 16 entries)
    -- ...

    -- Entry for Mother 16 (CutID = 4)
    (16, 100, 1, 4, 4, 4, '2023-03-07', '2023-03-07', 'Green', 1, 'Sold');
