...
CREATE TABLE Seeding (
    ...
    SeedID INT NOT NULL,
    DatePlanted DATE DEFAULT GETDATE() NOT NULL,
...
CREATE TABLE Seedling (
    ...
    SeedID INT NOT NULL,
    SproutDate DATE DEFAULT GETDATE() NOT NULL,
...
CREATE TABLE Mothers (
    ...
    DateMothered DATE DEFAULT GETDATE() NOT NULL,
    NumberOfBranches INT NOT NULL,
    LeafColour VARCHAR(150) NOT NULL,
    GeneticMarkerID INT NOT NULL,
    StrainID INT NOT NULL,
...
CREATE TABLE Maturity (
    ...
    DateOfMaturityCheck DATE DEFAULT GETDATE() NOT NULL,
    Height INT NOT NULL,
    NumberOfBranches INT NOT NULL,
    LeafColour VARCHAR(150) NOT NULL,
...
CREATE TABLE Cutting (
    ...
    CutDate DATE DEFAULT GETDATE() NOT NULL,
...
CREATE TABLE Transplant (
    ...
    CutID INT NOT NULL,
    TransplantDate DATE DEFAULT GETDATE() NOT NULL,
    HealthStatus BOOLEAN NOT NULL,
...
CREATE TABLE Daughter (
    ...
    Packaged BOOLEAN NOT NULL,
    DateDaughtered DATE DEFAULT GETDATE() NOT NULL,
    LeafColour VARCHAR(150) NOT NULL,
    HealthStatus BOOLEAN NOT NULL,
